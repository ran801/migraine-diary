        ...
        <div class ="p-3 flex">
            <table class="table-fixed border-separate w-full">
                ...
                <tr class="">
                    ...
                    <td class="border border-slate-300" v-for="(item,key,index) in tableData" :key="key" :index="index">{{item.q6}}</td>
                </tr>
                <tr class="">
                    <th class="bg-gray-500 text-white p-3">是否月經</th>
                    <td class="border border-slate-300-bg-red-50" v-for="(item,key,index) in tableData " :key="key" :index="index">{{item.q7}}</td>
                </tr>
                <tr class="">
...
export default ({
    ...
    methods:{
        ...
        minutes_to_hhmm(numberOfMinutes){
            let duration = moments.duration(numberOfMinutes , 'minutes');
